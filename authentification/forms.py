...
letter_validator = RegexValidator(
    regex=r'^(?!\s*$)(?!^"+$)(?:"?[A-Za-zÀ-ÖØ-öø-ÿ\s]+"?|[A-Za-zÀ-ÖØ-öø-ÿ\s]+)$',
    message='This field must contain only letters and spaces. It can be enclosed in quotes but cannot be empty or only quotes.'
)
